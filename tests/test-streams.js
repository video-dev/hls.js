...
const streams = {
  ...
  multiDRMBipbop: Object.assign({}, appleFPSv3Gatsby, {
    description: '(Internal) Multi-DRM Bipbop (fmp4)',
  ...
  AppleDV84: {
    url: '//localhost/adaptive/DolbyVision84/index.m3u8',
  ...
  meridian_local_with_subs: {
    ...
    url: '//localhost/adaptive/meridian/index.m3u8',
    audioTrackOptions: 1, // Has 4 audio renditions (aac and he-aac to two bitrates each),
    subtitleTrackOptions: 3,
  },
  meridian_local_with_assoc_lang_subs: {
    ...
    url: '//localhost/adaptive/meridian/index-assoc.m3u8',
    audioTrackOptions: 1, // Has 4 audio renditions (aac and he-aac to two bitrates each),
    subtitleTrackOptions: 3,
  },
  appleHvc1HevcIssue: {
    description: '(local) MVP says hvc1.2.4.H150.B0 media says hev1',
    url: '//localhost/adaptive/apple-events-hvc1/index-video-only.m3u8',
    skipFunctionalTests: true,
    audioTrackOptions: 1,
    subtitleTrackOptions: 0,
  },
  ...
  issue666: {
    url: '//localhost/adaptive/hls.js/issues/666/cisq0gim60007xzvi505emlxx.m3u8',
    description:
  ...
  issue1510: {
    url: '//localhost/adaptive/hls.js/issues/1510/caminandes_1_4k.m3u8',
    description: '#1510 Mixed TS and muxed mp4 Variant Playlists',
    audioTrackOptions: 0,
    subtitleTrackOptions: 0,
  },
  issue2706: {
    url: '//localhost/adaptive/hls.js/issues/2706/index.m3u8',
  ...
  issue2812: {
    url: '//localhost/adaptive/hls.js/issues/2812/index.m3u8',
  ...
  issue3179: {
    url: '//localhost/adaptive/hls.js/issues/3179/index.m3u8',
  ...
  issue3180: {
    url: '//localhost/adaptive/hls.js/issues/3180/index.m3u8',
    description:
  ...
  // issue4387: {
  //   url: '//localhost/adaptive/hls.js/issues/4387/***',
  //   description: '#4387 Missing video textTracks when using capLevelToPlayerSize',
  // },
  issue4470: {
    url: '//localhost/adaptive/hls.js/issues/4470/index.m3u8',
    description:
  ...
  issue4634: {
    url: '//localhost/adaptive/hls.js/issues/4634/index.m3u8',
    description:
  ...
  issue4783: {
    url: '//localhost/adaptive/hls.js/issues/4783/index.m3u8',
  ...
  issue4787: {
    url: '//localhost/adaptive/hls.js/issues/4787/index.m3u8',
  ...
  issue4817: {
    url: '//localhost/adaptive/hls.js/issues/4817/index.m3u8',
    description:
  ...
  // 4905
  issue4920: {
    url: '//localhost/adaptive/hls.js/issues/4920/index.m3u8',
  ...
  // 4943
  issue4958: {
    url: '//localhost/adaptive/hls.js/issues/4958/index.m3u8',
    description: '#4958 Containerless AAC, AC3, EC3 audio, with TS video',
    audioTrackOptions: 3,
    subtitleTrackOptions: 3, // 12 renditions
  },
  issue5162: {
    url: '//localhost/adaptive/hls.js/issues/5162/index.m3u8',
  ...
  issue5251: {
    url: '//localhost/adaptive/hls.js/issues/5251/index.m3u8',
  ...
  issue5255: {
    url: '//localhost/adaptive/hls.js/issues/5255/wrong.m3u8',
  ...
  issue5272: {
    url: '//localhost/adaptive/hls.js/issues/5272/index-start.m3u8',
  ...
  issue5302: {
    url: '//localhost/adaptive/hls.js/issues/5302/index.m3u8',
    description:
  ...
  issue5303: {
    url: '//localhost/adaptive/hls.js/issues/5303/index.m3u8',
  ...
  issue5378: {
    url: '//localhost/adaptive/hls.js/issues/5378/index-mvp.m3u8',
    description:
  ...
  issue5452: {
    url: '//localhost/adaptive/hls.js/issues/5452/cdn.brixcloud.io/record/63f2dabec589af0012210901645082a945f8d300121dd245/llhls.m3u8',
    description:
  ...
  issue5477: {
    url: '//localhost/adaptive/hls.js/issues/5477/index.m3u8',
    description: '#5477 start PTS overlaps with last DTS',
    audioTrackOptions: 1,
    subtitleTrackOptions: 0,
  },
  issue5481: {
    url: '//localhost/adaptive/hls.js/issues/5481/index.m3u8',
  ...
  issue5501: {
    url: '//localhost/adaptive/hls.js/issues/5501/index.m3u8',
  ...
  issue5504: {
    url: '//localhost/adaptive/hls.js/issues/5504/index.m3u8',
  ...
  issue5531: {
    url: '//localhost/adaptive/hls.js/issues/5531/index.m3u8',
  ...
  issue5631: {
    url: '//localhost/adaptive/hls.js/issues/5631/1/index.m3u8',
  ...
  issue5631_2: {
    url: '//localhost/adaptive/hls.js/issues/5631/2/index.m3u8',
  ...
  issue5632: {
    url: '//localhost/adaptive/hls.js/issues/5674/index.m3u8',
  ...
  issue5696: {
    ...
    url: '//localhost/adaptive/hls.js/issues/5696/index-decode-error.m3u8',
  ...
  issue5709: {
    url: '//localhost/adaptive/hls.js/issues/5709/index.m3u8',
    description:
  ...
  issue5743: {
    url: '//localhost/adaptive/hls.js/issues/5743/index.m3u8',
    description:
  ...
  issue5759: {
    url: '//localhost/adaptive/hls.js/issues/5759/index.m3u8',
    description:
  ...
  issue5782: {
    url: '//localhost/adaptive/hls.js/issues/5782/index.m3u8',
  ...
  // ),
  issue5857: {
    url: '//localhost/adaptive/hls.js/issues/5857/index.m3u8',
  ...
  // 5952
  issue5953: {
    url: '//localhost/adaptive/hls.js/issues/5953/index.m3u8',
  ...
  issue6191: {
    url: '//localhost/adaptive/hls.js/issues/6191/index.m3u8',
  ...
  issue6203_valid: {
    url: '//localhost/adaptive/hls.js/issues/6203/valid.m3u8',
    description:
  ...
  issue6203_short: {
    url: '//localhost/adaptive/hls.js/issues/6203/short.m3u8',
    description:
  ...
  issue6203: {
    url: '//localhost/adaptive/hls.js/issues/6203/index.m3u8',
    description:
  ...
  issue6294: {
    ...
    url: '//localhost/adaptive/hls.js/issues/6294/index.m3u8',
    audioTrackOptions: 0,
    subtitleTrackOptions: 0,
    skipFunctionalTests: true,
  },
  issue6337: {
    ...
    url: '//localhost/adaptive/hls.js/issues/6339/index.m3u8',
    audioTrackOptions: 0,
    subtitleTrackOptions: 0,
    skipFunctionalTests: true,
  },
  ...
  issue6392: {
    url: '//localhost/adaptive/hls.js/issues/4920/index-6392.m3u8',
  ...
  issue6475: {
    url: '//localhost/adaptive/bipbop_16x9/index-gap-subs.m3u8',
    description:
  ...
  issue6510: {
    url: '//localhost/adaptive/hls.js/issues/6510/index.m3u8',
  ...
  issue6529: {
    url: '//localhost/adaptive/hls.js/issues/6529/index.m3u8',
  ...
  closedCaptionsCPC608: {
    url: '//localhost/adaptive/cpcweb/index.m3u8',
