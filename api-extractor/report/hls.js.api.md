## API Report File for "@felixetienne.gauthier/hls.js"
...
export interface HlsListeners {
    ...
    // Warning: (ae-forgotten-export) The symbol "FragProgressData" needs to be exported by the entry point hls.d.ts
    //
    // (undocumented)
    [Events.FRAG_PROGRESS]: (event: Events.FRAG_PROGRESS, data: FragProgressData) => void;
    // (undocumented)
