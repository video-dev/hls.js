...
class MSEBufferController {
    ...
    get nextBufferRange() {
        if (this.mediaElem) {
            ...
            return this.followingBufferRange(
                this.getBufferRange(this.mediaElem.currentTime)
            );
        } else {
            return null;
        }
  ...
  */
    ...
    */
        ...
        nextRange = this.getBufferRange(
            this.mediaElem.currentTime + fetchdelay
        );
        if (nextRange) {
    ...
    onFragLoaded(event, data) {
        ...
        if (
            ...
            if (this.fragBitrateTest === true) {
                ...
                logger.log(
                    `Demuxing ${fragCurrent.sn} of [${details.startSN} ,${
                        details.endSN
                    }],level ${this.level}`
                );
                this.demuxer.push(
