 ...
 clearTimer() {
  ...
  get nextAutoLevel() {
    ...
    if(minAutoBitrate !== undefined) {
      const levelNextBitrate = levels[nextABRAutoLevel].realBitrate ? Math.max(levels[nextABRAutoLevel].realBitrate,levels[nextABRAutoLevel].bitrate) : levels[nextABRAutoLevel].bitrate;
