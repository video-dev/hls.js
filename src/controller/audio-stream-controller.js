...
class AudioStreamController extends EventHandler {
                    ...
                    if (
                        ...
                        let fragmentWithinToleranceTest = candidate => {
                            ...
                            if (
                                ...
                                candidate.start - candidateLookupTolerance >
                                    bufferEnd &&
                                candidate.start
                            ) {
                ...
                if (waitingFrag) {
                    ...
                    if (videoTrackCC !== waitingFragCC) {
                        ...
                        if (track.details && track.details.live) {
                            logger.warn(
                                `Waiting fragment CC (${waitingFragCC}) does not match video track CC (${videoTrackCC})`
                            );
                            this.waitingFragment = null;
                            this.state = State.IDLE;
                        }
    ...
    onFragParsingData(data) {
        ...
        if (
            ...
            let audioSwitch = this.audioSwitch,
                media = this.media,
                ...
                if (
                    ...
                    if (mediaBuffered) {
                        ...
                        if (
                            ...
                            // increase fragment load Index to avoid frag loop loading error after buffer flush
                            this.fragLoadIdx +=
                                2 * config.fragLoadingLoopThreshold;
                        }
                        this.state = State.IDLE;
                    } else {
