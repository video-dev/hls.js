            ...
            case State.IDLE:
                ...
                if (
                    ...
                    if (
                        !trackDetails.live &&
                        fragPrevious &&
                        fragPrevious.sn === trackDetails.endSN
                    ) {
                        ...
                        if (
                            !this.media.seeking ||
                            this.media.duration - bufferEnd <
                                fragPrevious.duration / 2
                        ) {
                    ...
                    if (audioSwitch) {
                        logger.log(
                            `switching track, find audio frag matching with currentTime/start:${pos}/${start}`
                        );
                        bufferEnd = pos;
