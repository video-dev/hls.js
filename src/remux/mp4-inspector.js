        ...
        parse = {
            ...
            avc1: function(data) {
                ...
                return {
                    ...
                    horizresolution:
                        view.getUint16(28) + view.getUint16(30) / 16,
                    vertresolution:
                        view.getUint16(32) + view.getUint16(34) / 16,
            ...
            ftyp: function(data) {
                ...
                while (i < data.byteLength) {
                    result.compatibleBrands.push(
                        parseType(data.subarray(i, i + 4))
                    );
                    i += 4;
                }
                return result;
            ...
            hdlr: function(data) {
                ...
                result.name = window.decodeURIComponent(
                    window.escape(result.name)
                );
            ...
            mdhd: function(data) {
                ...
                result.language += String.fromCharCode(
