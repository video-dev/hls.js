  ...
  generateIS(audioTrack,videoTrack,timeOffset) {
    ...
    if (audioTrack.config && audioSamples.length) {
      ...
      tracks.audio = {
        ...
        initSegment : MP4.initSegment([audioTrack], Math.round(audioTrack.timescale*editOffset/pesTimeScale)),
        metadata : {
    ...
    if (videoTrack.sps && videoTrack.pps && videoSamples.length) {
      ...
      tracks.video = {
        ...
        initSegment : MP4.initSegment([videoTrack], Math.round(videoTrack.timescale*editOffset/pesTimeScale)),
        metadata : {
