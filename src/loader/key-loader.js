  ...
  onDecryptKeyLoading(event, data) {
    ...
    if ((frag.decryptdata.uri != null) && (frag.decryptdata.key == null)) {
      if ((this.decrypturl == null) || (frag.decryptdata.uri !== this.decrypturl)) {
        ...
        this.loader.load(frag.decryptdata.uri, 'arraybuffer', this.loadsuccess.bind(this), this.loaderror.bind(this), this.loadtimeout.bind(this), config.fragLoadingTimeOut, config.fragLoadingMaxRetry, config.fragLoadingRetryDelay, this.loadprogress.bind(this), frag);
