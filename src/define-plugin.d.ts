...
// __HLS_UMD_BUNDLE__ is the name of the closure around the final UMD bundle.
declare const __HLS_UMD_BUNDLE__: Function;
// __HLS_UMD_WORKER__ true for UMD builds with worker injection support.
declare const __HLS_UMD_WORKER__: boolean;
